...
(function () {
  ...
  function createDefaultData() {
    const courses = [
      ...
      { id: "course-didac", name: "Didáctica en el uso de Recurso Informáticos", color: "#4b8dff", teacher: "Lic. Diana Torres Cruz", schedule: "Jue", description: "", weeklyGoal: 5, createdAt: Date.now() - 10000 },
      { id: "course-ofi", name: "Ofimática", color: "#b879ff", teacher: "Patricia Acuña", schedule: "Jue", description: "", weeklyGoal: 4, createdAt: Date.now() - 9000 },
      { id: "course-redes", name: "Instalación y con figuración de Redes de Comunicación", color: "#ff7c91", teacher: "Lic. Joaquin Rios", schedule: "Mie", description: "Comunicación oral, escrita y presentaciones efectivas.", weeklyGoal: 2, createdAt: Date.now() - 8000 },
      { id: "course-arte", name: "Cultura Artística", color: "#ffad4d", teacher: "Sanchez", schedule: "Lun", description: "", weeklyGoal: 4, createdAt: Date.now() - 7000 },
      { id: "course-comun", name: "Interpretación y Producción de textos", color: "#2ec8e6", teacher: "Mauricio Varillas Guzmán", schedule: "Mié", description: "", weeklyGoal: 4, createdAt: Date.now() - 6000 },
      { id: "course-inves", name: "Fundamentos de Investigación", color: "#6bd66b", teacher: "Layza", schedule: "Mar", description: "", weeklyGoal: 3, createdAt: Date.now() - 5000 },
      { id: "course-estad", name: "Estadistica General", color: "#f283c5", teacher: "Cruz", schedule: "Mar", description: "", weeklyGoal: 2, createdAt: Date.now() - 4000 },
      { id: "course-adm", name: "Administración de Redes", color: "#5fbcff", teacher: "Ninaja", schedule: "Mar", description: "", weeklyGoal: 2, createdAt: Date.now() - 3000 },
      { id: "course-herram", name: "Herramientas de Gestión de redes de Comunicación", color: "#ff8c52", teacher: "Ing. Nori Bobadilla", schedule: "Vie", description: "", weeklyGoal: 3, createdAt: Date.now() - 2000 },
      { id: "course-soft", name: "Software de Servidores de Red", color: "#a1e85a", teacher: "Ing. Nori Bobadilla", schedule: "Vie", description: "", weeklyGoal: 4, createdAt: Date.now() - 1000 }
    ];

    const tasks = [
      { id: "task-1", title: "Ficha Nro 01", courseId: "course-repair", description: "Completar Ficha 01 y estudiar.", dueDate: relativeISO(1), dueTime: "20:00", priority: "high", status: "progress", type: "delivery", createdAt: Date.now() - 700000, completedAt: null },
      { id: "task-2", title: "Trabajo nrop 01", courseId: "course-arte", description: "Responder preguntas sobre el video y material - subir al classroom", dueDate: relativeISO(2), dueTime: "22:00", priority: "high", status: "pending", type: "task", createdAt: Date.now() - 650000, completedAt: null },
      { id: "task-3", title: "Actividad 01", courseId: "course-redes", description: "Resolver las actividades y terminar de dibujar el plano", dueDate: relativeISO(3), dueTime: "19:30", priority: "medium", status: "pending", type: "task", createdAt: Date.now() - 600000, completedAt: null },
      /*
    ...
    const activities = [
      { id: "activity-1", date: todayISO(), time: "08:00", title: "Produccion de una obra literaria", courseId: "course-comun", description: "Ficticia , real o ambas", priority: "high", status: "completed", duration: 1, createdAt: Date.now() - 230000, completedAt: todayISO() },
      /*
